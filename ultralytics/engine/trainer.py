...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        with torch_distributed_zero_first(LOCAL_RANK):  # avoid auto-downloading dataset multiple times
            ...
            self.trainset, self.testset, self.trainirset, self.testirset = self.get_dataset() ### 2025-08
        self.ema = None
    ...
    def get_dataset(self):
        ...
        return data["train"], data.get("val"), data["train_ir"], data.get("val_ir") or data.get("test") ### 2025-08 ###
