...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        ...
        if img.shape[2]==6:
            ...
            tmp1 = cv2.copyMakeBorder(img[...,:3], top, bottom, left, right, cv2.BORDER_CONSTANT, value=(114, 114, 114)) 
            tmp2 = cv2.copyMakeBorder(img[...,3:], top, bottom, left, right, cv2.BORDER_CONSTANT, value=(114, 114, 114))   
