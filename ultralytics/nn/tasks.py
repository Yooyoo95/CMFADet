...
from ultralytics.nn.modules import (
    ...
    ADD,
    CIFusion, ### 2025-05-13
    CIFusion_v2, ### 2025-07-15
    CIFusion_v3, ### 2025-07-15
    CIFusion_v4, ### 2025-07-15
    CIFusion_v5, ### 2025-07-15
    CIFusion_v6, ### 2025-07-15
...
DETECT_CLASS = (Detect, Detect_DyHead, Detect_AFPN_P2345, Detect_AFPN_P2345_Custom, Detect_AFPN_P345, Detect_AFPN_P345_Custom, Detect_Efficient, DetectAux, Detect_SEAM, Detect_MultiSEAM, 
                Detect_DyHeadWithDCNV3, Detect_DyHeadWithDCNV4, Detect_DyHead_Prune, Detect_LSCD, Detect_ATAH, Detect_LADH, Detect_LSCSBD, Detect_LSDECD, Detect_RSCD, Detect_FGIF, Detect_LQE,
                Detect_LSCD_LQE)
V10_DETECT_CLASS = (v10Detect,)
SEGMENT_CLASS = (Segment, Segment_Efficient, Segment_LSCD, Segment_ATAH, Segment_LADH, Segment_LSCSBD, Segment_LSDECD, Segment_RSCD, Segment_LQE, Segment_LSCD_LQE)
POSE_CLASS = (Pose, Pose_LSCD, Pose_ATAH, Pose_LADH, Pose_LSCSBD, Pose_LSDECD, Pose_RSCD, Pose_LQE, Pose_LSCD_LQE)
OBB_CLASS = (OBB, OBB_LSCD, OBB_ATAH, OBB_LADH, OBB_LSCSBD, OBB_LSDECD, OBB_RSCD, OBB_LQE, OBB_LSCD_LQE,OBB_ATAH_v2)
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_DCNv2, C3k2_DCNv3,
               C3k2_DCNv2_Dynamic, C3k2_ContextGuided, C3k2_MSBlock, C3k2_DLKA, C3k2_EMBC, C3k2_DAttention, C3k2_Parc, C3k2_DWR, 
              C3k2_FocusedLinearAttention, C3k2_MLCA, C3k2_AKConv, C3k2_DWR_DRB, C3k2_AggregatedAtt, C3k2_DCNv4, C3k2_iRMB, C3k2_iRMB_Cascaded, C3k2_iRMB_DRB, C3k2_iRMB_SWC,
              C3k2_DynamicConv, C3k2_GhostDynamicConv, C3k2_RVB, C3k2_RVB_SE, C3k2_RVB_EMA, C3k2_RetBlock, C3k2_PKIModule,C3k2_Faster_CGLU, C3k2_Star, C3k2_Star_CAA,
              C3k2_EIEM, C3k2_DEConv, C3k2_Heat, C3k2_FMB, C3k2_gConv,
              C3k2_SMAFB, C3k2_SMAFB_CGLU,
              C3k2_MutilScaleEdgeInformationEnhance, C3k2_SFHF, C3k2_IDWC, C3k2_IDWB, C3k2_PConv, C3k2_EMA,
              C3k2_HFERB, C3k2_JDPM, C3k2_ETB, C3k2_FDT, C3k2_AP, C3k2_ELGCA, C3k2_ELGCACGLU, C3k2_Strip, C3k2_StripCGLU, C3k2_GlobalFilter, C3k2_DynamicFilter, IR_AFAB, 
              C3k2_TSSA, C3k2_MobileMamba, C3k2_MambaOut,  C3k2_LFEM
              )
A2C2F_CLASS = (A2C2f, A2C2f_CGLU, A2C2f_DFFN, A2C2f_FRFN)
C2PSA_CLASS = (C2PSA, C2BRA, C2CGA, C2DA, C2DPB, C2Pola, C2TSSA, C2PSA_CGLU)
class BaseModel(nn.Module):
    ...
    def _predict_once(self, x, profile=False, visualize=False, embed=None):
        ...
        rgb, ir=torch.chunk(x,chunks=2,dim=1) # 2025-08 RGB
        x = rgb
        isR =True # RGB or not
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        if isinstance(m, (DETECT_CLASS + SEGMENT_CLASS + POSE_CLASS + OBB_CLASS + V10_DETECT_CLASS)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
            ...
            try:
                ...
                m.stride = torch.tensor([s / x.shape[-2] for x in _forward(torch.zeros(2, 6, s, s))])  # forward 2025-08
                ...
                'CUDA tensor' in str(e) or 'is_cuda()' in str(e) or 'carafe_forward_impl' in str(e) or 'Pointer argument (at 0) cannot be accessed from Triton (cpu tensor?)' in str(e):
                    ...
                    m.stride = torch.tensor([s / x.shape[-2] for x in _forward(torch.zeros(2, 6, s, s).to(torch.device('cuda')))])  # forward 2025-08
                else:
                    raise e
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            C3x, RepC3, PSA, SCDown, C2fCIB, GSConv, GSConvns, VoVGSCSP, VoVGSCSPns, VoVGSCSPC, RCSOSA, CSPStage, SPDConv, RepBlock,
            SPPF_LSKA, CSP_EDLAN, nn.Conv2d, HWD, RepNCSPELAN4, DBBNCSPELAN4, OREPANCSPELAN4, DRBNCSPELAN4, RepNCSPELAN4_CAA, V7DownSampling,
            DGCST, RepNCSPELAN4_CAA, SRFD, DRFD, RGCSPELAN, CSP_PTB, GLSA, FeaturePyramidSharedConv,
            LDConv, MANet, MANet_FasterBlock, MANet_FasterCGLU, SFEM, 
            MANet_Star, PSConv, LoGStem, 
            ...
            if m in ((
                ...
                CSPStage, SPDConv, RepBlock, CSP_EDLAN, RGCSPELAN, CSP_PTB, SFEM, MANet,
                MANet_FasterBlock, MANet_FasterCGLU, MANet_Star
            ) + C3K2_CLASS + A2C2F_CLASS + C2PSA_CLASS):
                args.insert(2, n)  # number of repeats
                n = 1
            if m in ((C3k2,) + C3K2_CLASS) and scale in "mlx":  # for M/L/X sizes
                if m in (C3k2_AggregatedAtt, C3k2_MSBlock, C3k2_DAttention, C3k2_FocusedLinearAttention, C3k2_Parc,
                         C3k2_Heat, C3k2_PKIModule, C3k2_GlobalFilter, C3k2_DynamicFilter):
                    if type(args[-1]) == bool:
                        args[-1] = True
                    else:
                        args[-2] = True
        ...
        elif m in {AIFI, AIFI_RepBN, ETB, FDT}:
            args = [ch[f], *args]
            c2 = args[0]
            ...
            if m in SEGMENT_CLASS:
                args[2] = make_divisible(min(args[2], max_channels) * width, 8)
                if m in (Segment_LSCD, Segment_ATAH, Segment_LSCSBD, Segment_LSDECD, Segment_RSCD, Segment_LSCD_LQE):
                    args[3] = make_divisible(min(args[3], max_channels) * width, 8)
            if m in (Detect_LSCD, Detect_ATAH, Detect_LSCSBD, Detect_LSDECD, Detect_RSCD, Detect_LSCD_LQE):
                args[1] = make_divisible(min(args[1], max_channels) * width, 8)
            if m in (Pose_LSCD, Pose_ATAH, Pose_LSCSBD, Pose_LSDECD, Pose_RSCD, Pose_LSCD_LQE, 
                     OBB_LSCD, OBB_ATAH,OBB_ATAH_v2, OBB_LSCSBD, OBB_LSDECD, OBB_RSCD, OBB_LSCD_LQE ):
                args[2] = make_divisible(min(args[2], max_channels) * width, 8)
        ...
        ### 2025-08 ###
            ...
            args = [args[0]]
        ### 2025-08 ###
        elif m is CIFusion_v2:
            args = [args[0]]
        elif m in (CIFusion_v3, CIFusion_v4, CIFusion_v5, CIFusion_v6):
            args = [args[0]]
        elif m is ADD:
            c2 = ch[f[0]]
            args = [c2]
            ...
            c2 = m.channel
                   ...
                   DySample, CARAFE, CAA, ELA, CAFM, AFGCAttention, EfficientChannelAttention, ContrastDrivenFeatureAggregation, 
                   FSA,}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
