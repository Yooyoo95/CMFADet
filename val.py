...
if __name__ == '__main__':
    model_path = '/home/csyu/CMFADet/runs/OGSOD/train/Multi-Baseline-obb-256/weights/best.pt'
    model = YOLO(model_path)
    result = model.val( 
                        data='/home/csyu/ultralytics-yolo11-main/dataset/data_OGSOD_Multimodel.yaml', # DATASET PATH
                        ...
                        save_conf=True, 
                        save_txt=True, # if you need to cal coco metrice
                        project='runs/test/OGSOD',
                        name='Multi-Baseline-obb-256',
                        )
